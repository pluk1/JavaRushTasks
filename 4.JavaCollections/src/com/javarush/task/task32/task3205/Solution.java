...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        SomeInterfaceWithMethods originalInterface = new SomeInterfaceWithMethodsImpl();
        CustomInvocationHandler customHandler = new CustomInvocationHandler(originalInterface);
        Class<?>[] interfaces = originalInterface.getClass().getInterfaces();
        ClassLoader classLoader = originalInterface.getClass().getClassLoader();
        SomeInterfaceWithMethods someInterfaceWithMethods =
                (SomeInterfaceWithMethods) Proxy.newProxyInstance(classLoader, interfaces, customHandler);
